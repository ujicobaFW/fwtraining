...
L.LatLngGraticule = L.Layer.extend({
    options: {
        ...
        zoomInterval: [
            ...
            {start: 8, end: 14, interval: 0.05},
            {start: 15, end: 17, interval: 0.005},
...
// 	},
    ...
    __format_lat: function(lat) {
        ...
        if (lat < 0) {
            return '' + roundNumber(lat*-1,3) + 'S';
        }
        else if (lat > 0) {
            return '' + roundNumber(lat,3) + 'N';
        }
        return '' + lat;
    },
    ...
    __format_lng: function(lng) {
        ...
        // todo: format type of float
        if (lng > 180) {
            return '' + roundNumber(360 - lng, 3) + 'W';
        }
        else if (lng > 0 && lng < 180) {
            return '' + roundNumber(lng,3) + 'E';
        }
        else if (lng < 0 && lng > -180) {
            return '' + roundNumber(lng*-1,3) + 'W';
        }
        else if (lng == -180) {
            return '' + roundNumber(lng*-1,3);
        }
        else if (lng < -180) {
            return '' + roundNumber(360 + lng,3) + 'W';
        }
